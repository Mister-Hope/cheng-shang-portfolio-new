...
export const configs: Record<string, Config> = {
  en: {
    ...
    footer:
      "Built with ❤️ using React, TypeScript & Tailwind CSS. © 2024 Shang Cheng.",
    contents: [
      {
        type: "profile",
        id: "profile",
      ...
      },
      {
        ...
        data: [
          {
            type: "work",
            place: "Analytical Quantum Complexity RIKEN Hakubi Research Team",
            time: "Oct. 2024 - Present",
            title: "Postdoctoral Researcher",
            content: "with Dr. Tomotaka Kuwahara",
          },
          {
            type: "work",
            place: "Analytical Quantum Complexity RIKEN Hakubi Research Team",
          ...
          },
          {
            ...
            title: "Ph.D.",
            content: "with Prof. Naomichi Hatano",
          ...
          },
          {
            ...
            content:
              "Preparatory School for Chinese MEXT Doctoral Scholarship Candidate",
          },
          {
            type: "study",
      ...
      },
      {
        ...
        data: {
          content:
            "**Special Collection: Discover Physics (Springer Nature)**. Submission Deadline: 21 April, 2026.",
        ...
        data: [
          {
            year: "2025",
            content:
              "Our work on '[Topological Quantum Batteries](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.134.180401)' was featured in **PRL Trending**.",
            link: "https://x.com/PhysRevLett/status/1924474721149542443",
          },
          {
            year: "2025",
            content:
              "Highlight in press releases by RIKEN and selected for RIKEN Research.",
            link: "https://www.riken.jp/en/news_pubs/research_news/pr/2025/20250513_2/index.html",
          },
          {
            year: "2024",
            content: "Joined Kuwahara team as a Postdoc on Oct 1st.",
          },
          {
            year: "2024",
            content:
              "Presented posters at QIP2024, TQC2024, and Quantum Innovation 2024.",
          },
          {
            year: "2024",
            content: "Received Ph.D. from the University of Tokyo.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        data: [
          ...
          },
          {
            ...
            link: "https://service.cnki.net/KCMS/detail/detail.aspx",
          },
        ],
      },
      {
        ...
        data: [
          {
            text: "Zhi-Guang Lu et al., *Topological Quantum Batteries*, Phys. Rev. Lett. 134, 180401 (2025)",
            link: "https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.134.180401",
          },
          {
            text: "Bo-Wang Zhang et al., *Manipulating spectral transitions*, Phys. Rev. A 111, 063702 (2025)",
            link: "https://journals.aps.org/pra/abstract/10.1103/PhysRevA.111.063702",
          },
          {
            text: "Cheng Shang & Hong-Chao Li, *Resonance-dominant entanglement*, Physical Review Applied 21, 044048 (2024)",
      ...
      },
      {
        ...
        data: [
          ...
          },
          {
            ...
            date: "2024",
            description:
              "Attending the 21st PHHQP-XXI Workshop in the beautiful city of Chania. It was a great opportunity to share our latest research on non-Hermitian systems with the global physics community and enjoy the Mediterranean sunset after a day of intense scholarly exchange.",
          },
          {
            ...
            date: "2023",
            description:
              "Balance is key, both in physics and in breaking. This session was part of our weekly practice at a local studio in Tokyo where we explore movement, rhythm, and the limits of physical expression outside the academic environment.",
          },
        ],
      },
    ],
    ...
    contents: [
      ...
      },
      {
        ...
        data: [
          {
            type: "work",
            place: "分析量子复杂性 RIKEN Hakubi 研究团队",
            time: "2024 年 10 月 - 至今",
            title: "博士后研究员",
            content: "与 桑原知剛 博士",
          },
      ...
      },
      {
        ...
        data: [
          {
            year: "2025",
            content: "工作“**拓扑量子电池**”入选 PRL Trending。",
            link: "https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.134.180401",
          },
          {
            year: "2025",
            content: "理化学研究所发布新闻稿报道，并入选理化学研究所专刊。",
            link: "https://www.riken.jp/press/2025/20250513_2/index.html",
          },
      ...
      },
      {
        ...
        data: [
          {
            text: "Zhi-Guang Lu 等, *拓扑量子电池*, Phys. Rev. Lett. 134, 180401 (2025)",
            link: "https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.134.180401",
          },
        ],
      },
        ...
        data: [
          {
            ...
            date: "2024 年 9 月",
            description:
              "这是我在东京大学完成博士论文答辩的那一天。论文探讨了开放量子系统中的退相干抑制。那一刻标志着我多年学术追求的一个重要节点，也开启了作为独立研究者的新篇章。",
          },
          {
            url: "https://picsum.photos/seed/p2/1200/800",
            title: "希腊学术会议",
            ...
            date: "2024",
            description:
              "在希腊哈尼亚参加 PHHQP-XXI 研讨会。在这座充满历史气息的海滨小城，与来自全球的同行共同探讨非厄密系统的奇妙现象，碰撞出许多科研灵感的火花。",
          },
        ],
      },
    ],
